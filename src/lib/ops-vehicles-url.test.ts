...
describe('ops-vehicles-url (Story 17.12)', () => {
	...
	it('buildOpsVehiclesHref', () => {
		expect(buildOpsVehiclesHref({ view: 'list', id: null })).toBe('/ops/fleet/vehicles')
		expect(buildOpsVehiclesHref({ view: 'grid', id: null })).toBe('/ops/fleet/vehicles?view=grid')
		...
		).toBe('/ops/fleet/vehicles?view=grid&id=v1111111-1111-4111-8111-111111111111')
	})
})
